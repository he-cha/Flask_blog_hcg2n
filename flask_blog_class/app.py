...
@app.route('/')
def index():
    #get a connection to the datatbase
    conn = get_db_connection()
...
def create():
    ...
    if request.method == 'POST':
        ...
        #else make a database connnection and insert the post content
        if not title:
...
#create a route to delte a post
#delete route can only be processed with a POST method
#the post id is a url route
